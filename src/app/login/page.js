    ...
    <div className='min-h-screen flex justify-center items-center'>
      <div className='bg-white text-black w-[300px] p-5 h-[300px] rounded-md'>
        ...
        <div className='flex flex-col items-center gap-6  p-4'>
          ...
          <input type="password" value={user.password} onChange={(e) => setUser({ ...user, password: e.target.value })} className='p-2 border border-slate-300 rounded-md' placeholder='Enter your password' />
